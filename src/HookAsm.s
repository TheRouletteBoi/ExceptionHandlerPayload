...
.type   HookSyscallPrepareDispatch,@function
.section .opd,"aw",@progbits
HookSyscallPrepareDispatch: 
.p2align 3
.quad  .HookSyscallPrepareDispatch
.quad  .TOC.@tocbase
.quad  0
.section .text,"ax",@progbits
...
.HookSyscallPrepareDispatch:
    ...
    oris %r2, %r2, __toc@h
    ori %r2, %r2, __toc@l
    oris %r0, %r0, sysDbgWriteProcessMemoryHook2@h
    ori %r0, %r0, sysDbgWriteProcessMemoryHook2@l
    subf %r0, %r0, 2
    mflr %r2
    addi %r2, %r2, -32
    add  %r2, %r2, 0
    bl sysDbgWriteProcessMemoryHook2
    ld %r2, 40(%r1)
    ld %r0, 32(%r1)
    mtlr %r0
    blr
